...
# Creating two dictionaries that map that questions words and the answers words to a unique integer
threshold = 20
questionswords2int = {}
word_number = 0
...
def model_inputs():
    ...
    keep_prob = tf.placeholder(tf.float32, name = 'keep_prob') # controls drop out rate
...
def encoder_rnn(rnn_inputs, rnn_size, num_layers, keep_prob, sequence_length):
    ...
    _, encoder_state = tf.nn.bidirectional_dynamic_rnn(cell_fw = encoder_cell,
                                                       ...
                                                       inputs = rnn_inputs,
                                                       dtype = tf.float32) # encoder_output, encoder_state
...
def decode_training_set(encoder_state, decoder_cell, decoder_embedded_input,
    ...
    decoder_output, _, _ = tf.contrib.seq2seq.dynamic_rnn_decoder(decoder_cell,
                                                                  ...
                                                                  sequence_length,
                                                                  scope = decoding_scope) #decoder_output, decoder_final_state, decoder_final_context_state
...
def decode_test_set(encoder_state, decoder_cell, decoder_embeddings_matrix, sos_id, eos_id, maximum_length, num_words,
    ...
    test_predictions, _, _ = tf.contrib.seq2seq.dynamic_rnn_decoder(decoder_cell,
                                                                  ...
                                                                  scope = decoding_scope) #decoder_final_state, decoder_final_context_state
