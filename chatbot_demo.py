...
## trimming
clean_ans=clean_ans[:120000]
clean_ques=clean_ques[:120000]
## delete
...
model.fit([encoder_inp, decoder_inp],decoder_final_output,epochs=2)

scores = model.evaluate([encoder_inp, decoder_inp],decoder_final_output, verbose=0)
